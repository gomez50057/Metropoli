...
export const blogPosts = [
  {
    name: "¡La coordinación metropolitana avanza hacia una nueva etapa para el Valle de México!",
    description: 'Se llevó a cabo la Novena Sesión Ordinaria de 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México (CDMVM), con representantes de la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), así como de los gobiernos de Hidalgo, Ciudad de México, Estado de México y Morelos, los cuales se reunieron para dar continuidad a los trabajos de actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM), revisar los avances de la consulta indígena, definir la ruta para la consulta pública y fortalecer la coordinación rumbo a la Primera Sesión Ordinaria del Consejo.  \n  En representación del Gobierno del Estado de Hidalgo, el Coordinador General de Planeación y Proyectos, Onésimo Rodrigo Serrano Rivera, reiteró el compromiso de la entidad para fortalecer la coordinación y la comunicación permanente entre los equipos técnicos, con el propósito de garantizar el éxito de los trabajos del Consejo. \n Como parte de los avances presentados, se dio seguimiento al proceso de consulta indígena que acompaña la actualización del POZMVM, destacando las acciones que continúan desarrollándose en Hidalgo para fortalecer el diálogo con autoridades agrarias y comunidades de Tula de Allende y Tepeji del Río, garantizando un proceso participativo, incluyente y respetuoso de los derechos de los pueblos y comunidades indígenas.  \n Se presentaron los preparativos para la Consulta Pública del POZMVM, la cual contempla la realización de foros temáticos, audiencias públicas y conversatorios en las cuatro entidades participantes, con el objetivo de incorporar la participación ciudadana en la construcción de un instrumento de planeación que responda a los retos territoriales, ambientales, económicos y sociales de la región metropolitana. \n De igual forma, se presentó la ruta de trabajo del Fondo Conjunto para los Objetivos de Desarrollo Sostenible (ODS) de la ONU, iniciativa que busca fortalecer proyectos metropolitanos mediante financiamiento, asistencia técnica internacional y acciones orientadas al desarrollo sostenible de la Zona Metropolitana del Valle de México. \n Con estos avances, las entidades participantes refrendan su compromiso de mantener una coordinación permanente para consolidar una planeación metropolitana moderna, participativa y con visión de largo plazo, capaz de responder a los desafíos comunes y promover un desarrollo territorial más ordenado, resiliente y sostenible para una de las regiones metropolitanas más importantes del país.',
    date: "03 de julio, 2026",
    image: "/img/noticias/ZMVM/La coordinación metropolitana avanza hacia una nueva etapa para el Valle de México.png",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "La coordinación metropolitana se fortalece para construir el futuro del Valle de México",
    description: 'Durante la Octava Sesión Ordinaria de 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México (CDMVM), representantes de Hidalgo, Estado de México, Ciudad de México, Morelos y la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU) revisaron los aspectos técnicos, operativos y jurídicos necesarios para la celebración de la Primera Sesión Ordinaria del Consejo, así como el avance del proceso de actualización del POZMVM.  \n Entre los principales temas abordados destacó la preparación de los acuerdos que permitirán someter a consideración la ampliación de la Zona Metropolitana del Valle de México mediante la incorporación del estado de Morelos, así como la aprobación del anteproyecto del POZMVM para dar inicio a su consulta pública, fortaleciendo la gobernanza metropolitana y la coordinación interestatal. \n En representación del Gobierno del Estado de Hidalgo, la Directora General de Desarrollo Regional y Metropolitano, Marlene López García, planteó observaciones para fortalecer la claridad jurídica de los acuerdos y propuso que la incorporación de los siete municipios hidalguenses se realizara de manera simbólica durante el acto protocolario, además de sugerir ajustes al contenido audiovisual previsto para la sesión del Consejo. \n Asimismo, se presentó el avance de la consulta indígena que acompaña la actualización del POZMVM. En el caso de Hidalgo se informó sobre las acciones que continúan desarrollándose en los municipios de Tepeji del Río y Tula de Allende para garantizar la participación de comunidades y autoridades tradicionales conforme a los procesos establecidos. \n Otro de los temas relevantes fue la presentación de la ruta de trabajo vinculada con el ONU Boot Camp Bilbao, donde se destacó el interés de ONU-Hábitat en impulsar proyectos metropolitanos con enfoque de Ciudad Esponja, resultado del trabajo técnico desarrollado en el marco del POZMVM. La propuesta contempla la creación de mecanismos financieros que permitan materializar proyectos prioritarios orientados a fortalecer la resiliencia urbana y ambiental de la región. ',
    date: "19 de junio, 2026",
    image: "/img/noticias/ZMVM/La coordinación metropolitana se fortalece para construir el futuro del Valle de México.png",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "Hidalgo participa en la consolidación de estrategias para el desarrollo metropolitano del Valle de México",
    description: 'Durante la Séptima Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México, realizada el 22 de mayo en la Ciudad de México, autoridades de la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), así como representantes de la Ciudad de México y de los estados de México, Hidalgo y Morelos, dieron continuidad a los trabajos relacionados con la actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM). \n En el marco de esta sesión se presentaron los avances de la Consulta Pública y Consulta Indígena del POZMVM, proceso que ha contemplado diversos mecanismos como audiencias públicas, foros institucionales, conversatorios y herramientas digitales de participación ciudadana, con el propósito de fortalecer la transparencia, la gobernanza metropolitana y la construcción colectiva de soluciones para el desarrollo de la región. \n Asimismo, se expuso la estrategia para la aprobación de los instrumentos jurídicos que darán sustento a la coordinación metropolitana de la Zona Metropolitana del Valle de México, entre los que destacan el Primer Convenio Modificatorio al Convenio de Coordinación para la instalación del Consejo de Desarrollo Metropolitano del Valle de México, la Declaratoria de Modificación por Ampliación de la ZMVM y los Lineamientos Operativos del Consejo de Desarrollo Metropolitano del Valle de México. Dichos instrumentos serán impulsados a través de la Primera Sesión Ordinaria del Consejo, instancia presidida por la SEDATU, la Jefa de Gobierno de la Ciudad de México, el Gobernador del Estado de Hidalgo y las Gobernadoras de los estados de México y Morelos. \n La realización de estas acciones representa uno de los ejercicios de coordinación metropolitana más relevantes, al permitir la generación de acuerdos, estrategias y mecanismos de colaboración intergubernamental orientados a consolidar una visión compartida del desarrollo urbano, territorial y sostenible de la zona metropolitana más grande y compleja del país.',
    date: "22 de mayo, 2026",
    image: "/img/noticias/ZMVM/Hidalgo participa en la consolidación de estrategias para el desarrollo metropolitano del Valle de México.jpeg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "Así se vivió la Consulta Indígena en Hidalgo",
    description: ' **Comunidades indígenas del municipio de Tula de Allende participan en la Actualización del POZMVM.** \n Como parte del proceso de Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM), en coordinación con la SEDATU, el INPI, la UPLAPH y autoridades municipales de Tula de Allende, se llevó a cabo la Consulta Indígena en el municipio con el propósito de garantizar la participación de las comunidades indígenas y afromexicanas en la construcción del instrumento de planeación metropolitana, mediante la participación de las localidades de El Llano 1a Sección, San Miguel de las Piedras, San Miguel de las Piedras 2a Sección, Santa María Macuá, Xijay de Cuauhtémoc, Xiteje de la Reforma y Santa María Michimaltongo.  \n El proceso se realizó en un periodo de febrero a abril de 2026, donde la población de las comunidades expresó sus necesidades, como resultado, se recibieron más de 138 propuestas, relacionadas con el medio ambiente, desarrollo urbano, economía, sociedad, cultura, campo y agricultura. \n Todas las propuestas emitidas durante la Consulta Indígena serán consideradas en el Programa, fortaleciendo una planeación metropolitana con enfoque territorial, ambiental y social, que reconozca la participación de las comunidades indígenas y afromexicanas en la construcción del futuro de la Zona Metropolitana del Valle de México.',
    date: "22 de mayo, 2026",
    image: "/img/noticias/ZMVM/Así se vivió la Consulta Indígena en Hidalgo_22052026.jpeg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "Avanza el POZMVM, programa clave para el desarrollo urbano metropolitano",
    description: 'Autoridades federales y estatales consolidan la siguiente etapa del **Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)** mediante mecanismos de participación para consulta pública, y coordinación regional. \n **Durante la Sexta Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México**, realizada en el Estado de México, encabezada por el  Mtro. José Alfonso Iracheta Carroll, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, el Ing. Carlos Jesús Maza Lara, Titular de la Secretaría de Desarrollo Urbano e Infraestructura del estado de México, y el Mtro. Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos del estado de Hidalgo, las entidades participantes dieron seguimiento a los trabajos del Programa de Ordenación de la Zona Metropolitana del Valle de México considerado uno de los principales instrumentos de planeación territorial y desarrollo urbano para la región metropolitana más grande del país. \n En la sesión se destacó que, por primera vez en décadas, las cuatro entidades que integran la ZMVM mantienen un trabajo coordinado y sostenido para construir una visión metropolitana común que atienda retos compartidos en materia de crecimiento urbano, movilidad, medio ambiente, infraestructura y gobernanza territorial. \n Asimismo, se presentó la estrategia de actividades y el calendario preliminar para la Consulta Pública del POZMVM, proceso que contempla audiencias públicas, foros institucionales, conversatorios y mecanismos digitales de participación ciudadana, con el objetivo de fortalecer la transparencia y la construcción colectiva de soluciones metropolitanas. \n Durante los trabajos se resaltó la importancia de incorporar herramientas digitales accesibles, así como ampliar la participación de juventudes e infancias en los procesos de consulta, a fin de construir una planeación metropolitana más incluyente y cercana a la ciudadanía. \n Las entidades coincidieron en la importancia de fortalecer el diálogo comunitario y garantizar mecanismos participativos que incorporen las necesidades y perspectivas de los pueblos originarios en la planeación territorial metropolitana. \n Durante la reunión se destacó que el POZMVM representa uno de los ejercicios de coordinación metropolitana más relevantes de los últimos años, resultado del trabajo conjunto entre las entidades federativas y el Gobierno de México para construir una visión compartida del desarrollo territorial de la región. \n Finalmente, las entidades participantes reiteraron el compromiso de consolidar el POZMVM como un instrumento estratégico de gobernanza y planeación metropolitana, orientado a promover un desarrollo urbano más ordenado, sostenible e incluyente para millones de habitantes del Valle de México.',
    date: "30 de abril, 2026",
    image: "/img/noticias/ZMVM/Avanza el POZMVM programa clave para el desarrollo urbano metropolitano.jpeg",
    category: "ZMVM",
    featuredPosts: false,
    bgPosts: false
  },
  {
    name: '“Ciudad Esponja” innovación urbana para el Valle de México',
    description: 'Hidalgo fue sede de la Quinta Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México, encabezada por el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, y el Mtro. José Alfonso Iracheta Carroll, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda donde autoridades federales y estatales impulsaron una visión de desarrollo urbano sostenible basada en infraestructura ecológica y resiliencia hídrica para la Zona Metropolitana del Valle de México. \n Durante la sesión se presentó el proyecto **“Ciudad Esponja”**, iniciativa que busca replantear el modelo urbano metropolitano mediante soluciones basadas en la naturaleza para atender problemáticas relacionadas con inundaciones, escasez de agua y cambio climático. \n La estrategia toma como referencia experiencias internacionales de infraestructura ecológica y propone incorporar mecanismos urbanos capaces de **absorber, retener y filtrar agua pluvial**, restaurando funciones del ciclo hidrológico y fortaleciendo la resiliencia de las ciudades. \n Entre los beneficios expuestos destacan: \n* Fortalecimiento de la seguridad hídrica, \n* Reducción de riesgos por inundaciones, \n* Recuperación ambiental, \n* Resiliencia climática, \n* Mejora del espacio público, \n* y reducción de costos de infraestructura a largo plazo. \n Asimismo, se destacó la importancia de integrar la visión de *“Metrópoli Esponja”* dentro del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM), a fin de impulsar proyectos metropolitanos con enfoque ambiental, territorial y social. \n Como parte de los trabajos metropolitanos, también se revisaron avances de la Agenda Metropolitana y del Modelo de Ordenamiento Territorial, así como la consolidación de proyectos prioritarios relacionados con movilidad, gestión hídrica, infraestructura verde y recuperación ecológica. \n Durante la reunión se informó además que la propuesta presentada ante la Organización de las Naciones Unidas para impulsar mecanismos de financiamiento vinculados a la visión de “Ciudad Esponja” fue seleccionada como un caso innovador de gobernanza metropolitana. \n Como parte de los trabajos metropolitanos, también se revisaron los avances de la Consulta Indígena del POZMVM, reconociendo la importancia de construir procesos de planeación territorial con enfoque participativo, respeto a los pueblos originarios y atención a las realidades sociales y ambientales de las comunidades. \n Finalmente, las entidades acordaron dar continuidad al proyecto “Metrópoli Esponja” mediante las Comisiones Metropolitanas del Consejo de Desarrollo Metropolitano del Valle de México.',
    date: "10 de abril, 2026",
    image: "/img/noticias/ZMVM/Ciudad Esponja innovación urbana para el Valle de México.jpg",
    category: "ZMVM",
    featuredPosts: false,
    bgPosts: false
  },
  {
    name: "4ta Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México",
    description: "En seguimiento a la Agenda Metropolitana del Valle de México, el viernes 13 de marzo del presente año, se reunieron en la CDMX, el Mtro. José Alfonso Iracheta Carroll, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, Mtro. Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional de la SEDATU, Mtro. Pablo Enrique Yanes Rizo, Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana, del gobierno de la CDMX, Mtra. Valeria Hamel Sierra, Directora de Coordinación Metropolitana, Mtro. Onésimo Serrano Rivera, Coordinador General de Planeación y Proyectos, del estado de Hidalgo, Mtro. Luis Gilberto Marrón Agustín, Director General de Proyectos y Coordinación Metropolitana del Gobierno del estado de México, así como servidores públicos de los ámbitos federal y estatal. \n El objetivo de la reunión fue la presentación y revisión de: \n* Operación del Consejo de Desarrollo Metropolitano del Valle de México (CDMVM); \n* Conformación del Consejo Consultivo de Desarrollo Metropolitano (CCDM); y \n* Logística de la 1ª. Sesión Ordinaria del Consejo de Desarrollo Metropolitano. \n Entre los acuerdos, se estableció dar continuidad a un trabajo colaborativo y coordinado entre las cuatro entidades y la SEDATU, con la finalidad de realizar las adecuaciones del Convenio Modificatorio, el Convenio de Coordinación para la instalación del Consejo de Desarrollo Metropolitano del Valle de México (CDMVM) y la Declaratoria de Modificación por Ampliación de la limitación de la ZMVM, así como elaborar los criterios para la conformación del Consejo Consultivo de Desarrollo Metropolitano. \n Así mismo, cada entidad presentará una **propuesta de sede** para la primera Sesión del Consejo de Desarrollo Metropolitano del Valle de México, la cual será sometida a consideración del Secretariado Técnico Conjunto. \n Finalmente, en la quinta sesión del Secretariado Técnico que se llevará acabo el 10 de abril en el estado de Hidalgo, se presentará el proyecto **“Ciudad Esponja”**, por parte del municipio de Atizapán de Zaragoza, así como la presentación y adecuación al Modelo de Ordenamiento Territorial (MOT) y la Agenda Metropolitana.",
    date: "13 de marzo, 2026",
    image: "/img/noticias/ZMVM/4ta Sesión Ordinaria 2026 del STC del CDMVM.jpg",
    category: "ZMVM",
    featuredPosts: false,
    bgPosts: false
  },
  {
    name: "3ra Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México",
    description: "En seguimiento a la Agenda Metropolitana del Valle de México, el viernes 20 de febrero del presente año, se reunieron en el estado de Morelos, el Dr. José Alfonso Iracheta Carroll, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, Mtro. Onésimo Serrano Rivera, Coordinador General de Planeación y Proyectos, del estado de Hidalgo, Mtro. Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional de la SEDATU, Mtra. Valeria Hamel, Directora General de Coordinación Metropolitana del Gobierno de la CDMX, Ing. Margarita Arias Osorio, Directora General de Operación y Obras de la Secretaría del Agua del Estado de México, Mtro. Luis Gilberto Marrón Agustín, Director General de Proyectos y Coordinación Metropolitana del Gobierno del Estado de México,  Dr. Daniel Pérez Torres, Director de la Consultoría en Planeación, Desarrollo y Territorio, así como servidores públicos de los ámbitos federal y estatal. \n El objetivo de la reunión fue la **presentación de resultados del Taller de Priorización de Proyectos de la Agenda Metropolitana de la ZMVM**, así como los trabajos vinculados al Consejo de Desarrollo Metropolitano. \n Entre los acuerdos, se estableció que los proyectos que tengan vinculación con temas hídricos, se conjuntarán en una propuesta denominada **“Ciudad Esponja”**, buscando la viabilidad y acercamiento con el municipio de Atizapán de Zaragoza. \n Los **10 proyectos prioritarios**, se llevarán a corto plazo y se estarán trabajando en la Comisiones de la Zona Metropolitana del Valle de México. \n La SEDATU, envió el Convenio Modificatorio CDMVM y la Declaratoria de Modificación por ampliación de la delimitación de la Zona Metropolitana del Valle de México, para su revisión de la Consejerías Jurídicas de la CDMX, y los estados del Estado de México, Hidalgo y Morelos. \n De manera paralela, se estará trabando en la Ley de Coordinación Metropolitana que hace referencia art. 122 constitucional, sin que retrase la culminación de la Actualización del POZMVM. \n El 13 de marzo del presente año, se aprobarán los Lineamientos Operativos del Consejo de Desarrollo Metropolitano del Valle de México y la Convocatoria de elección de las y los integrantes del Consejo Consultivo de Desarrollo Metropolitano.",
    date: "20 de febrero, 2026",
    image: "/img/noticias/ZMVM/3ra Sesión Ordinaria 2026 del STC del CDMVM.jpg",
    category: "ZMVM",
    featuredPosts: false,
    bgPosts: false
  },
  {
    name: "2da Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México",
    description: "En seguimiento a la Agenda Metropolitana del Valle de México, el viernes 6 de febrero del presente año, se reunieron de manera virtual, el Mtro. Pablo Enrique Yanes Rizo, Titular de la Secretaría de Planeación, Ordenamiento Territorial y Coordinación Metropolitana, la Ing. Arq. Marlene López García, Directora General de Desarrollo Regional y Metropolitana en representación del Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, el Mtro. Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional SEDATU, Ing. Margarita Arias Osorio, Directora General de Operación y Obras  de la Secretaría del Agua del Estado de México, así como servidores públicos de los ámbitos federal y estatal. \n El objetivo de la reunión consistió en la *Evaluación de la Agenda Metropolitana** para la definición de los **proyectos prioritarios** de la Zona Metropolitana del Valle de México, así como la revisión del estado que guardan los trabajos vinculados al Consejo de Desarrollo Metropolitano del Valle de México. \n  Entre los acuerdos, se estableció definir de manera conjunta **los proyectos estratégicos e integrales** de alto impacto, garantizando que cuenten con la anuencia de las y los titulares del Secretariado Técnico de las cuatro entidades. Asimismo, se acordó contar con los anteproyectos del **Convenio Modificatorio CDMVM; Declaratoria de Modificación por ampliación de la delimitación de la Zona Metropolitana del Valle de México; Reglamento Interior del CDMVM; y la Convocatoria de elección de las y los integrantes del Consejo Consultivo de Desarrollo Metropolitano.**",
    date: "06 de febrero, 2026",
    image: "/img/noticias/ZMVM/2da Sesión Ordinaria 2026 del STC del CDMVM.jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "1ra Sesión Ordinaria 2026 del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México",
    description: "En seguimiento a la Agenda Metropolitana del Valle de México, el miércoles 21 de enero del presente año, se reunieron en el municipio de Metepec, del estado de México, el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, el Mtro. Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos, Mtro. Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional de la SEDATU, Lic. Luis Gilberto Marrón, Director General de Proyectos y Coordinación Metropolitana del Estado de México, Mtra. Valeria Hamel, Directora General de Coordinación Metropolitana del Gobierno de la CDMX, así como servidores públicos de los ámbitos federal y estatal. \n El objetivo de la reunión fue definir la **ruta para la operación del Consejo de Desarrollo Metropolitano del Valle de México (CDMVM)**, así como la revisión de los siguientes anteproyectos: \n* **a) Convenio Modificatorio del CDMVM;** \n* **b) Declaratoria de Modificación por ampliación de la delimitación de la Zona Metropolitana del Valle de México (ZMVM);** \n* **c) Reglamento Interior del CDMVM; y** \n* **d) Convocatoria de elección de integrantes del Consejo Consultivo de Desarrollo Metropolitano.** \n Durante la sesión se informó que, como parte de los trabajos vinculados a la Consulta Indígena, se han programado reuniones de coordinación con las autoridades correspondientes, para implementar las asambleas: \n* Viernes 30 de enero, **Asamblea Informativa** en la comunidad de Coajuomulco, Morelos. \n*  Primer acercamiento en el marco de Actos y Acuerdos previos en los municipios de Tepeji de Río de Ocampo y Tula de Allende, en el estado de Hidalgo. \n* Se realizarán reuniones de trabajo de coordinación con los enlaces del Estado de México y Ciudad de México.",
    date: "21 de enero, 2026",
    image: "/img/noticias/ZMVM/1ra Sesión Ordinaria 2026 del STC del CDMVM.jpeg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "18va Sesión de Trabajo del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México. Actualización del POZMVM",
    description: "En seguimiento a la Actualización del Programa de Ordenamiento de la Zona Metropolitana del Valle de México, el miércoles 17 de diciembre del presente año, se reunieron en el estado de Hidalgo el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, lo acompaña Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional SEDATU, Luis Gilberto Marrón, Director General de Proyectos y Coordinación Metropolitana del Estado de México, Valeria Hamel, Directora General de Coordinación Metropolitana de la CDMX, así como personal de la consultoría que realiza el Programa y demás servidores públicos de las 4 Entidades e invitados especiales. \n Los objetivos de esta reunión fueron consolidar el apartado de monitoreo y evaluación, presentar la síntesis del POZMVM, así como analizar las conclusiones sobre la fase de elaboración y programación de actividades para 2026. \n Uno de los temas que se destacó fue la propuesta de crear una plataforma territorial metropolitana derivada de los trabajos de los programas de ordenación, con el objetivo de socializar información sobre la gestión de proyectos y del programa; fortalecer la rendición de cuentas; facilitar el acceso ciudadano a información mediante un Sistema de Información Geográfica (SIG); así como dar seguimiento al avance de proyectos, temas metropolitanos e indicadores. \n **Contar con la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México es fundamental para atender de manera integral y coordinada los retos que enfrenta una de las metrópolis más complejas y dinámicas del país.**",
    date: "17 de diciembre, 2025",
    image: "/img/noticias/ZMVM/18va Sesión de Trabajo del STCDMVM. actualización del POZMVM.jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "17va Sesión de Trabajo del Secretariado Técnico Conjunto del Consejo de Desarrollo Metropolitano del Valle de México. Actualización del POZMVM",
    description: "En seguimiento a la Actualización del Programa de Ordenamiento de la Zona Metropolitana del Valle de México, el miércoles 3 de diciembre del presente año, se reunieron en la Ciudad de México el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, lo acompaña José Alfonso Iracheta Carroll, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional SEDATU, Pablo Yanes, Secretario de Desarrollo Urbano y Vivienda de CDMX, Luis Gilberto Marrón, Director General de Proyectos y Coordinación Metropolitana del Estado de México, así como personal de la consultoría que realiza el Programa y demás servidores públicos de las 4 Entidades e invitados especiales. \n Los objetivos de esta reunión fueron consolidar la propuesta de estrategias y agenda metropolitana, así como presentar el diagnóstico, proyectos, acciones y políticas en materia de monitoreo y evaluación. \n Uno de los temas que se destacó fue la construcción de indicadores, los cuales deberán construirse de manera que reflejen información útil y coherente, que pueda ser utilizada en la creación de políticas públicas. \n **La coordinación interinstitucional y entre entidades federativas es un elemento indispensable para consolidar la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM), ya que permite articular visiones, competencias y responsabilidades en un territorio funcional que trasciende límites administrativos. Solo mediante el trabajo conjunto es posible construir diagnósticos compartidos, definir criterios técnicos homogéneos y establecer acuerdos que orienten un desarrollo territorial ordenado, equilibrado y sostenible.**",
    date: "03 de diciembre, 2025",
    image: "/img/noticias/ZMVM/17va Sesión de Trabajo del STCDMVM. actualización del POZMVM.png",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  ...
  },
  {
    ...
    description: "Como parte del proceso de elaboración del **Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)**, se llevó a cabo el **Segundo Taller de Planeación Participativa**, concebido como un espacio de diálogo, reflexión y construcción conjunta del diagnóstico metropolitano. Este encuentro forma parte de un esquema de dos ciclos participativos orientados a integrar la visión de actores clave de los sectores público, social, académico y privado de la metrópoli. \n Este espacio de dialogo se llevó a cabo **el día 28 de octubre de 2025** en el Complejo Colibrí, en el municipio de Tizayuca, Hidalgo. El objetivo del taller fue retroalimentar y generar consensos sobre la construcción y propuesta del Modelo de Ordenamiento Territorial (MOT), así como legitimar los proyectos prioritarios de la agenda metropolitana propuestos en la actualización del POZMVM. \n El encuentro reunió a cerca de 65 personas, entre ellas funcionarias y funcionarios de los gobiernos Federal, Estatal y Municipal, además de representantes de sectores clave de la sociedad civil organizada y ciudanía. Este evento contó con la participación destacada de Gretchen Alyne Atilano Moreno, Presidenta Municipal de Tizayuca; Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos de la Unidad de Planeación y Prospectiva (UPLAPH); Marlene López García, Directora General de Desarrollo Regional y Metropolitano de la UPLAPH; Luis Gilberto Marrón Agustín, Director General de Proyectos y Coordinación Metropolitana de la Secretaría de Desarrollo Urbano e Infraestructura del Estado de México (SEDUI); y Xóchitl Berenice Ramírez Cañas, Directora de Ordenamiento Regional de la SEDATU. \n Durante la jornada se presentaron los avances generales del Programa y se explicó la metodología participativa de los ciclos de talleres. Posteriormente, se trabajó en mesas temáticas relacionadas con medio ambiente, agua, riesgos y cambio climático, vivienda, derecho a la ciudad, movilidad y seguridad vial, **dinámica demográfica y economía**, y metrópoli segura. Los principales hallazgos se obtuvieron a partir de cada mesa de participación, las cuales identificaron problemáticas metropolitanas prioritarias, condicionamientos territoriales y potencialidades que representan oportunidades clave para orientar la planeación futura, mediante ejercicios de localización geográfica y análisis colectivo. Dichos hallazgos fueron sistematizados de manera jerárquica, al constituir insumos para la construcción dinámica del diagnóstico del POZMVM. La participación registrada evidenció un fuerte compromiso con el proceso de planeación y reafirmó la importancia de mantener un enfoque participativo y transparente. Los insumos generados en este primer ciclo serán fundamentales para fortalecer el diagnóstico del Programa y orientar los trabajos del segundo ciclo de talleres, enfocado en la validación del Modelo de Ordenamiento Territorial (MOT).",
  ...
  },
  {
    ...
    description: "Como parte del proceso de elaboración del **Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)**, se llevó a cabo el **Segundo Taller de Planeación Participativa**, concebido como un espacio de diálogo, reflexión y construcción conjunta del diagnóstico metropolitano. Este encuentro forma parte de un esquema de dos ciclos participativos orientados a integrar la visión de actores clave de los sectores público, social, académico y privado de la metrópoli. \n Este espacio de dialogo se llevó a cabo a las **10:00 horas el 23 de octubre de 2025** en el Auditorio municipal de Tlaxcoapan. El objetivo general del taller fue retroalimentar y generar consensos sobre la construcción y propuesta del Modelo de Ordenamiento Territorial (MOT), así como legitimar los proyectos prioritarios de la agenda metropolitana propuestos en la actualización del POZMVM, así como informar sobre sus avances. \n El encuentro reunió a cerca de 65 personas, entre ellas funcionarias y funcionarios de los gobiernos Federal, Estatal y Municipal, además de representantes de sectores clave de la sociedad civil organizada y ciudadanía. Este evento contó con la destacada participación de Teresa Olivares Reyna, Presidenta Municipal de Tlaxcoapan; Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos de la Unidad de Planeación y Prospectiva (UPLAPH); Enrique Soto Alba, Director General de Ordenamiento Metropolitano y Regional de la SEDATU; Marlene López García, Directora General de Desarrollo Regional y Metropolitano de la UPLAPH; y Luis Gilberto Marrón Agustín, Director General de Proyectos y Coordinación Metropolitana de la Secretaría de Desarrollo Urbano e Infraestructura del Estado de México (SEDUI). \n Durante la jornada se presentaron los avances generales del Programa y se explicó la metodología participativa de los ciclos de talleres. Posteriormente, se trabajó en mesas temáticas relacionadas con medio ambiente, agua, riesgos y cambio climático, vivienda, derecho a la ciudad, movilidad y seguridad vial, **dinámica demográfica y economía**, y metrópoli segura. Los principales hallazgos se obtuvieron a partir de cada mesa de participación, las cuales identificaron problemáticas metropolitanas prioritarias, condicionamientos territoriales y potencialidades que representan oportunidades clave para orientar la planeación futura, mediante ejercicios de localización geográfica y análisis colectivo. Dichos hallazgos fueron sistematizados de manera jerárquica, al constituir insumos para la construcción dinámica del diagnóstico del POZMVM. \n  La participación registrada evidenció un fuerte compromiso con el proceso de planeación y reafirmó la importancia de mantener un enfoque participativo y transparente. Los insumos generados en este primer ciclo serán fundamentales para fortalecer el diagnóstico del Programa y orientar los trabajos del segundo ciclo de talleres, enfocado en la validación del Modelo de Ordenamiento Territorial (MOT).",
  ...
  },
  {
    ...
    description: "Como parte del proceso de elaboración del **Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)**, se llevó a cabo el **Primer Taller de Planeación Participativa**, concebido como un espacio de diálogo, reflexión y construcción conjunta del diagnóstico metropolitano. Este encuentro forma parte de un esquema de dos ciclos participativos orientados a integrar la visión de actores clave de los sectores público, social, académico y privado de la metrópoli. \n Este encuentro se llevó a cabo a las 10:00 horas el **25 de julio de 2025** en el Sicas Jardín, en Tula de Allende, Hidalgo. El objetivo general del taller fue identificar temáticas relevantes, condicionamientos y potencialidades del territorio desde la perspectiva de los diversos actores metropolitanos, tomando en cuenta cada una de las dimensiones de análisis que componen el apartado diagnóstico del POZMVM. \n El encuentro reunió a cerca de 75 personas, entre ellas funcionarias y funcionarios de los gobiernos Federal, Estatal y Municipal, además de representantes de sectores clave de la sociedad civil organizada y ciudadanía. Este evento contó con la participación destacada de Cristhian Evanivaldo Martínez Reséndiz, Presidente Municipal de Tula de Allende; Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos de la Unidad de Planeación y Prospectiva (UPLAPH); Enrique Soto Alba, Director General de Ordenamiento Metropolitano y Regional de la SEDATU; Marlene López García, Directora General de Desarrollo Regional y Metropolitano de la UPLAPH; Jennifer Diana Hernández González, Directora de Gobernanza y Política Metropolitana y Regional de la SEDATU; y de Daniela López Hernández, Directora de Planeación del municipio de Tula de Allende. \n Durante la jornada se presentaron los avances generales del Programa y se explicó la metodología participativa de los ciclos de talleres. Posteriormente, se trabajó en mesas temáticas relacionadas con medio ambiente, agua, riesgos y cambio climático, vivienda, derecho a la ciudad, movilidad y seguridad vial, población y economía, y metrópoli segura. Los principales hallazgos se derivaron de cada mesa de participación, en las que se identificaron problemáticas metropolitanas prioritarias, condicionamientos territoriales y potencialidades que representan oportunidades clave para orientar la planeación futura, mediante ejercicios de localización geográfica y análisis colectivo; dichos hallazgos fueron sistematizados de manera jerárquica, al constituir insumos para la construcción dinámica del diagnóstico del POZMVM. Finalmente, se avanzó en la definición de una visión preliminar orientada a una metrópoli más sostenible, resiliente y mejor coordinada. \n La participación registrada evidenció un fuerte compromiso con el proceso de planeación y reafirmó la importancia de mantener un enfoque participativo y transparente. Los insumos generados en este primer ciclo serán esenciales para fortalecer el diagnóstico del Programa y orientar los trabajos del segundo ciclo de talleres, centrado en la validación del Modelo de Ordenamiento Territorial (MOT).",
  ...
  },
  {
    ...
    description: "Como parte del proceso de elaboración del **Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)** , se llevó a cabo el **Primer Taller de Planeación Participativa**, concebido como un espacio de diálogo, reflexión y construcción conjunta del diagnóstico metropolitano. Este encuentro forma parte de un esquema de dos ciclos participativos orientados a integrar la visión de actores clave de los sectores público, social, académico y privado de la metrópoli. \n Este encuentro se llevó a cabo a las 10:00 horas el día **24 de julio de 2025** en el Instituto Tecnológico de Atitalaquia. El objetivo general del taller fue identificar temáticas relevantes, condicionamientos y potencialidades del territorio desde la perspectiva de los diversos actores metropolitanos, tomando en cuenta cada una de las dimensiones de análisis que componen el apartado diagnóstico del POZMVM. \n El encuentro reunió alrededor de 100 personas, entre ellas funcionarias y funcionarios de los gobiernos Federal, Estatal y Municipal, además de representantes de sectores clave de la sociedad civil organizada y ciudadanía. Este evento contó con la participación destacada de Claudia Arisbee Sandoval Ramírez, Presidenta Municipal de Atitalaquia; Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos de la Unidad de Planeación y Prospectiva (UPLAPH); Marlene López García, Directora General de Desarrollo Regional y Metropolitano de la UPLAPH; Leticia Herrera Bautista , Directora de Ordenamiento Metropolitano de la SEDATU y de Abel Cerón San Nicolás, Director General del Instituto Hidalguense para el Desarrollo Municipal (INDEMUN). \n Durante la jornada se presentaron los avances generales del Programa y se explicó la metodología participativa de los ciclos de talleres. Posteriormente, se trabajó en mesas temáticas relacionadas con medio ambiente, agua, riesgos y cambio climático, vivienda, derecho a la ciudad, movilidad y seguridad vial, **población y economía**, y metrópoli segura. Los principales hallazgos se obtuvieron a partir de cada mesa de participación, ya que en ellas se identificaron problemáticas metropolitanas prioritarias, condicionantes territoriales y potencialidades que representan oportunidades clave para orientar la planeación futura, mediante ejercicios de localización geográfica y análisis colectivo; dichos hallazgos fueron sistematizados de manera jerárquica, al constituir insumos para la construcción dinámica del diagnóstico del POZMVM. Finalmente, se avanzó en la definición de una visión preliminar que proyecta una metrópoli más sostenible, resiliente y mejor coordinada. \n La participación registrada evidenció un fuerte compromiso con el proceso de planeación y reafirmó la importancia de mantener un enfoque participativo y transparente. Los insumos generados en este primer ciclo serán esenciales para fortalecer el diagnóstico del Programa y orientar los trabajos del segundo ciclo de talleres, centrado en la validación del Modelo de Ordenamiento Territorial (MOT).",
  ...
  },
  {
    ...
    description: "Continuando con los trabajos de la **Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México**, el miércoles 25 de abril del presente año se llevó a cabo una reunión en la Ciudad de México con la participación del Mtro. Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos, en representación del Mtro. Miguel Ángel Tello Vargas, titular de la Unidad de Planeación y Prospectiva; así como de Víctor Hugo Hofmann Aguirre, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda; Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional de la SEDATU; Alejandro Encinas Rodríguez, Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México; Carlos Maza Lara, Secretario de Desarrollo Urbano e Infraestructura del Estado de México; Patricia Ramírez Kuri, titular del Instituto de Planeación Democrática y Prospectiva (IPDP); Selina Trujillo Arizmendi, Diputada del Distrito XXXI del Estado de México; así como Roberto Eibenschutz Hartman, por parte de la consultoría. \n La reunión tuvo como objetivos presentar el Plan de Trabajo de la consultoría responsable de la elaboración del POZMVM, revisar los avances en la integración de la información correspondiente a cada entidad federativa, así como la suscripción, por parte de las cuatro entidades federativas, de los Convenios de Coordinación para impulsar el ordenamiento territorial y la planeación urbana de la Zona Metropolitana del Valle de México. Como acuerdo, se estableció la realización de reuniones quincenales para dar continuidad a los trabajos de la Actualización del POZMVM. \n La Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM) constituye un instrumento estratégico para la coordinación del desarrollo urbano metropolitano, por lo que su actualización resulta fundamental para promover un crecimiento más ordenado, equitativo y sustentable.",
  ...
  {
    name: "14va Reunión de Coordinación para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "Continuando con los trabajos de la **Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México**, el miércoles 9 de abril del presente año se llevó a cabo una reunión virtual con la participación de la Ing. Arq. Marlene López García, Directora General de Desarrollo Regional y Metropolitano, en representación del Mtro. Miguel Ángel Tello Vargas, titular de la Unidad de Planeación y Prospectiva; así como de Víctor Hugo Hofmann Aguirre, Subsecretario de Ordenamiento Territorial, Urbano y Vivienda; Enrique Soto Alva, Director General de Ordenamiento Metropolitano y Regional de la SEDATU; Valeria Hamel, asesora del Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana, en representación del Secretario Alejandro Encinas Rodríguez; Luis Gilberto Marrón Agustín, Director General de Proyectos y Coordinación Metropolitana, en representación de Carlos Maza Lara; y Harald Alcaraz, Director de Planeación e Instrumentación Territorial, en representación del Secretario Alan Dupré. \n El objetivo de la reunión fue atender las dudas relacionadas con la información solicitada por la SEDATU para el proceso de elaboración de la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México y la consistencia técnica del mismo, así como presentar las primeras consideraciones técnicas derivadas del proceso de consulta indígena que se llevará a cabo para la elaboración de dicho Programa. \n La participación y colaboración interinstitucional en la elaboración de la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México resulta indispensable para garantizar el éxito en la construcción de este instrumento de planeación estratégica de alcance metropolitano.",
    date: "09 de abril, 2025",
    image: "/img/noticias/ZMVM/14va Reunión de Coordinación para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México.jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "Reunión preparatoria para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México",
    description: "Continuando con los trabajos de la **Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México**, el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva, sostuvo una reunión con representantes de la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), así como de las Secretarías de Gobierno; Movilidad y Transporte; Salud; Cultura; Medio Ambiente y Recursos Naturales; Hacienda; Infraestructura Pública y Desarrollo Urbano Sostenible; Educación Pública y Turismo del Gobierno del estado de Hidalgo. Asimismo, participaron representantes de la Comisión Estatal del Agua y de la Comisión Estatal para el Desarrollo Sostenible de los Pueblos Indígenas, además de presidentas y presidentes municipales, así como titulares de planeación y desarrollo urbano de los municipios de Tula de Allende, Tepeji del Río de Ocampo, Atitalaquia, Tlaxcoapan, Atotonilco de Tula, Tolcayuca, Villa de Tezontepec y Tizayuca. \n Durante la reunión se dieron a conocer los alcances de dicho Programa, así como las estrategias de coordinación necesarias para integrar la información requerida en el proceso de elaboración de este instrumento de planeación. Dicho Programa tiene como objetivo promover el desarrollo integral entre los estados y las demarcaciones que conforman la metrópoli, atendiendo de manera inclusiva y efectiva los principales retos metropolitanos, con una visión orientada a fortalecer la gobernanza y la colaboración interinstitucional, mediante políticas, directrices, acciones y proyectos de alcance metropolitano. \n La suma de esfuerzos y la participación coordinada de los municipios que integran la ZMVM, junto con las dependencias del Gobierno del Estado, resultan indispensables para consolidar un instrumento de planeación que genere beneficios tangibles para la población y contribuya al desarrollo ordenado y sostenible de la Zona Metropolitana.",
    date: "02 de abril, 2025",
    image: "/img/noticias/ZMVM/Reunión preparatoria para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México.jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: true
  },
  {
    name: "13va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM)",
    description: "Como parte de la continuidad de los trabajos para la Actualización del Programa de Ordenación Metropolitana del Valle de México, el Mtro. Onésimo Rodrigo Serrano Rivera, en representación del Mtro. Miguel Ángel Tello Vargas, titular de la Unidad de Planeación y Prospectiva, participó en una reunión virtual coordinada por la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU). \n En dicha sesión participaron el Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, Víctor Hugo Hofmann Aguirre; el secretario de Desarrollo Urbano e Infraestructura del Estado de México, Carlos Maza Lara; el secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México, Alejandro Encinas Rodríguez; y el secretario de Desarrollo Sustentable del estado de Morelos, Alan Dupré Ramírez. \n Durante la reunión se subrayó la importancia de la coordinación interinstitucional entre las entidades participantes para la integración de la Actualización del Programa de Ordenación Metropolitana del Valle de México. En este sentido, se destacó que dicha **coordinación resulta fundamental para consolidar un instrumento eficaz de planeación, gestión y ejecución de proyectos estratégicos de alcance metropolitano.**",
    date: "26 de marzo, 2025",
    image: "/img/noticias/ZMVM/13va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "12va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM)",
    description: "Con el objetivo de dar seguimiento a los trabajos de la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México, el Mtro. Miguel Ángel Tello Vargas, Titular de la Unidad de Planeación y Prospectiva, participó en la reunión virtual coordinada por el Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la SEDATU, Víctor Hugo Hofmann Aguirre, donde además participaron el Secretario de Desarrollo Urbano e Infraestructura del Estado de México, Carlos Maza Lara, el Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México, Alejandro Encinas Rodríguez, el Secretario de Desarrollo Sustentable del estado de Morelos, Alan Dupré Ramírez. \n En esta reunión se definió y validó la delimitación de la ZMVM de 84 municipios para la elaboración del POZMVM, de igual manera se acordó incorporar proyectos estratégicos de gran impacto al Plan Maestro, entre los que se encuentran el Trolebús Elevado que va del municipio de Ixtapaluca en el Estado de México a la estación Martín Carrera del metro en la Ciudad de México. \n **La Actualización del Programa de Ordenación Metropolitano del Valle de México es fundamental para garantizar un desarrollo sostenible, equitativo y eficiente, mejorar la calidad de vida, optimizar la infraestructura, impulsar la economía y preservar el medio ambiente, asegurando que el crecimiento de la metrópoli sea ordenado y funcional para sus habitantes.**",
    date: "26 de febrero, 2025",
    image: "/img/noticias/ZMVM/12va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "11va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM)",
    description: "En seguimiento a los trabajos del Programa de Ordenamiento de la Zona Metropolitana del Valle de México, el Secretario de Desarrollo Urbano e Infraestructura del Estado de México, Carlos Maza Lara, el Subsecretario de Ordenamiento Territorial, Urbano y Vivienda de la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), Víctor Hugo Hofmann Aguirre, el Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México, Alejandro Encinas Rodríguez, el Titular de la Secretaría del Agua del Estado de México, Pedro Moctezuma Barragán, el Secretario de Desarrollo Sustentable del estado de Morelos, Alan Dupré Ramírez, así como el Coordinador General de Planeación y Proyectos, Onésimo Rodrigo Serrano Rivera, se reunieron el 28 de enero de 2025, para llevar a cabo la décima primera reunión para la elaboración del POZMVM. \n En esta décima sesión se acordó incluir municipios de Hidalgo, Estado de México y Morelos a la Zona Metropolitana del Valle de México, los cuales buscarán publicarse en gacetas municipales y periódicos oficiales estatales para su reconocimiento técnico-jurídico. Esta incorporación permitirá generar estrategias para atender necesidades conjuntas. \n Con la **_Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (ZMVM), se atenderá la necesidad de ordenar la ZMVM_**, así como las **_zonas de impacto del Aeropuerto Internacional Felipe Ángeles (AIFA) y del Tren AIFA – Pachuca_**.",
    date: "28 de enero, 2025",
    image: "/img/noticias/ZMVM/11va Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "10ma Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM)",
    description: "En seguimiento a los trabajos para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (ZMVM), el Titular de la Unidad de Planeación y Prospectiva del estado de Hidalgo, Mtro. Miguel Ángel Tello Vargas, sostuvo una reunión el 15 de enero de 2025 con la secretaria de Desarrollo Agrario, Territorial y Urbano (SEDATU), Edna Vega Rangel; el Subsecretario de Desarrollo Urbano y Vivienda de la SEDATU, Víctor Hugo Hofmann Aguirre; el Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México, Alejandro Encinas; y el Secretario del Agua del Estado de México, Pedro Moctezuma. \n Durante esta décima sesión se analizaron los alcances del Programa, los proyectos estratégicos que deberá integrar, así como los pasos a seguir para consolidar una zona metropolitana planificada, ordenada y con visión de largo plazo. \n Contar con un Programa de Ordenamiento de la Zona Metropolitana del Valle de México permitirá generar beneficios estratégicos para el desarrollo sostenible de la región, mejorar la calidad de vida de la población y fortalecer la gobernanza metropolitana de una de las zonas más relevantes del país.",
    date: "15 de enero, 2025",
    image: "/img/noticias/ZMVM/10ma Reunión de Coordinación para la Actualización del Programa de Ordenación Metropolitano del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "9na Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "El 11 de diciembre de 2024 se llevó a cabo la Novena Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (ZMVM), en las instalaciones de la Secretaría de Planeación, Ordenamiento Territorial y Coordinación Metropolitana, encabezada por el secretario Alejandro Encinas. Durante la sesión se presentó el diagnóstico general y los principales retos en materia de gobernanza y coordinación metropolitana en las entidades que conforman la ZMVM, Ciudad de México, Estado de México e Hidalgo, así como los avances del Atlas de Riesgos de la Zona Metropolitana del Valle de México. \n La reunión contó con la participación de representantes del Gobierno de la Ciudad de México, del Estado de México, del estado de Hidalgo y del Gobierno Federal. \n Mediante estas acciones se busca fortalecer la provisión de servicios públicos, mejorar la infraestructura y elevar la calidad de vida de la población, así como promover un uso más eficiente y sustentable del suelo y de los recursos naturales. \n En particular, la elaboración del Atlas de Riesgos de la Zona Metropolitana del Valle de México tiene como objetivo apoyar la planeación de un crecimiento urbano más seguro, evitando el desarrollo de vivienda, infraestructura y equipamiento en zonas de alto riesgo, así como identificar áreas vulnerables a riesgos naturales como: inundaciones, deslizamientos de tierra o sismos y a otros riesgos, entre ellos la contaminación del aire o los accidentes industriales. Esto permitirá la toma de decisiones preventivas orientadas a mitigar los impactos antes de que dichos riesgos se materialicen.",
    date: "11 de diciembre, 2024",
    image: "/img/noticias/ZMVM/9na Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  ...
  },
  {
    ...
    description: "En representación del titular de la Unidad de Planeación y Prospectiva del Gobierno del Estado de Hidalgo, Miguel Ángel Tello Vargas, Onésimo Rodrigo Serrano Rivera, Coordinador General de Planeación y Proyectos, participó junto con el Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana de la Ciudad de México, Alejandro Encinas Rodríguez, y el Secretario de Desarrollo Urbano e Infraestructura del Estado de México, en la mesa redonda denominada **_“Retos y desafíos en la coordinación, planeación y ordenamiento de la Zona Metropolitana del Valle de México”._** \n Durante la mesa se abordaron los principales retos para lograr una coordinación efectiva entre los distintos órdenes de gobierno, así como la construcción de estrategias conjuntas para atender problemáticas prioritarias como la movilidad, el abastecimiento de agua, la gestión de residuos sólidos y la contaminación del aire, entre otros temas clave. Asimismo, se discutieron acciones orientadas a garantizar una planeación y un ordenamiento territorial eficaces en la Zona Metropolitana del Valle de México. \n Este evento, encabezado por la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), tiene como objetivo fortalecer la coordinación y la gobernanza metropolitana en el país, mediante la definición de estrategias que permitan enfrentar de manera integral los desafíos de las zonas metropolitanas. ",
  ...
  {
    name: "8va Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: " **¡Impulso a la movilidad!** \n El pasado 28 de noviembre de 2024 se llevó a cabo la Octava Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (ZMVM), en la que se presentó el diagnóstico general, así como los principales retos y acciones en materia de financiamiento, turismo, movilidad y desarrollo económico de las entidades que conforman la zona metropolitana. \n La reunión contó con la participación del Subsecretario Víctor Hugo Hofmann Aguirre, en representación de la Secretaría de Desarrollo Agrario, Territorial y Urbano (SEDATU), así como de Álvaro Lomelí Covarrubias, Coordinador General de Desarrollo Metropolitano y Movilidad, además de otros representantes de la SEDATU y de Onésimo Rodrigo Serrano Rivera, en representación del titular de la Unidad de Planeación y Prospectiva del estado de Hidalgo. \n A través de estas acciones se busca mejorar la calidad de vida de la población, fortalecer la economía regional, reducir los impactos negativos sobre el medio ambiente y promover la inclusión social. En este contexto, una movilidad eficiente, sostenible e inclusiva resulta clave para atender los desafíos urbanos de la región, particularmente aquellos relacionados con el transporte y la conectividad, y para avanzar hacia un futuro más equitativo y resiliente para la Zona Metropolitana del Valle de México.",
    date: "28 de noviembre, 2024",
    image: "/img/noticias/ZMVM/8va Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "7ma Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "Como parte de los trabajos para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México, el titular de la Unidad de Planeación y Prospectiva, Mtro. Miguel Ángel Tello Vargas, sostuvo una reunión el pasado 13 de noviembre con representantes del Gobierno de la Ciudad de México, del Gobierno del Estado de México y de la SEDATU, en la que se abordaron los principales retos y acciones en materia de vivienda en las entidades que conforman la Zona Metropolitana del Valle de México. \n Uno de los objetivos centrales es avanzar hacia un entorno urbano más equilibrado, sostenible, seguro e inclusivo, acorde con las necesidades y desafíos actuales de la región, incorporando medidas que eviten el desarrollo de vivienda en zonas de alto riesgo y garanticen la seguridad y bienestar de la población.",
    date: "13 de noviembre, 2024",
    image: "/img/noticias/ZMVM/7ma Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "6ta Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "Como parte de la Agenda Metropolitana del Valle de México, el 30 de octubre de 2024 se llevó a cabo una reunión en la que se abordaron temas relacionados con asentamientos humanos, equipamiento e infraestructura, en el marco de los trabajos previos para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (ZMVM). En este encuentro participaron las entidades que conforman la ZMVM, Estado de México, Ciudad de México e Hidalgo en coordinación con la SEDATU. \n La discusión de estos temas resulta fundamental, ya que permite avanzar hacia una metrópoli más ordenada, inclusiva, sostenible y resiliente. Una adecuada planeación y distribución de los asentamientos humanos, así como del equipamiento y la infraestructura, contribuye a mejorar las condiciones de vida de la población, optimizar el uso de los recursos urbanos, reducir desigualdades y fortalecer la capacidad de la zona metropolitana para enfrentar desafíos futuros. \n Asimismo, mediante una planeación integral se busca garantizar que los asentamientos humanos se desarrollen en zonas adecuadas, cuenten con la infraestructura necesaria para su correcto funcionamiento y se consoliden bajo criterios de sostenibilidad a largo plazo.",
    date: "30 de octubre, 2024",
    image: "/img/noticias/ZMVM/6ta Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "5ta Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "El jueves 17 de octubre de 2024 se llevó a cabo la Quinta Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM), con la participación del Secretario de Planeación, Ordenamiento Territorial y Coordinación Metropolitana, Alejandro Encinas; del Coordinador General de Desarrollo Metropolitano y Movilidad, Álvaro Lomelí Covarrubias; así como de representantes de la SEDATU y del Gobierno del estado de Hidalgo, entre ellos Onésimo Rodrigo Serrano Rivera, en representación del titular de la Unidad de Planeación. \n Durante la reunión se abordaron los principales retos en materia de Gestión Integral de Riesgos y Desastres, así como de Cambio Climático, que enfrentan las entidades que conforman la Zona Metropolitana del Valle de México, con el objetivo de fortalecer estrategias conjuntas que permitan hacer frente a los desafíos derivados de la alta densidad poblacional, la vulnerabilidad ante desastres naturales y los problemas ambientales de la región. \n A través de un enfoque coordinado y de largo plazo, estas acciones contribuyen a la protección de la vida humana, la sostenibilidad ambiental y el desarrollo económico y social de la región, garantizando su resiliencia frente a los futuros riesgos climáticos y naturales.",
    date: "17 de octubre, 2024",
    image: "/img/noticias/ZMVM/5ta Reunión para la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    name: "3ra Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM)",
    description: "En seguimiento a los trabajos de la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México, el titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, Mtro. Miguel Ángel Tello Vargas, sostuvo una reunión el 12 de septiembre del 2024 con representantes del Gobierno Federal, a través de la SEDATU, del Gobierno del Estado de México, del Gobierno de la Ciudad de México, así como con Lyzbeth Robles Gutiérrez, Secretaria de Movilidad y Transporte de Hidalgo. \n Durante el encuentro se dio seguimiento a los avances del Programa y se hizo énfasis en la importancia de consolidar un sistema de transporte público en la ZMVM que sea seguro, sustentable e interconectado, a fin de garantizar desplazamientos eficientes para la población, sin que las divisiones municipales o estatales representen una limitación. \n Asimismo, se destacó que el transporte público constituye un eje estratégico para mejorar la movilidad y reducir la congestión vial, así como para avanzar hacia una metrópoli más sostenible, equitativa y funcional. Su fortalecimiento resulta clave para asegurar el acceso a oportunidades y servicios, impulsar el desarrollo económico, disminuir el impacto ambiental y promover un modelo de urbanización más ordenado y eficiente, por lo que se subrayó la necesidad de invertir de manera integral en su mejora y expansión dentro del desarrollo de la Zona Metropolitana del Valle de México.",
    date: "12 de septiembre, 2024",
    image: "/img/noticias/ZMVM/3ra Reunión previa a la Actualización del Programa de Ordenación de la Zona Metropolitana del Valle de México (POZMVM).jpg",
    category: "ZMVM",
    featuredPosts: true,
    bgPosts: false
  },
  {
    ...
    description: "Con la participación de representantes del Gobierno del Estado de México y del Gobierno de la Ciudad de México, así como del titular de la Unidad de Planeación y Prospectiva del Estado de Hidalgo, Mtro. Miguel Ángel Tello Vargas, se llevó a cabo la reunión de seguimiento con el equipo de transición de la SEDATU el 29 de agosto de 2024, en la que se abordaron temas relacionados con la movilidad y el crecimiento ordenado de la Zona Metropolitana del Valle de México. \n Como resultado del encuentro, se acordó la realización de reuniones quincenales que permitirán la integración de carteras de proyectos, así como el diseño de estrategias y acciones coordinadas en materia hídrica, movilidad, medio ambiente, gestión de residuos sólidos, financiamiento, asentamientos humanos y migración, entre otros rubros prioritarios. \n Estas acciones contribuirán al fortalecimiento de la coordinación intergubernamental y a la mejora de la calidad de vida de las y los hidalguenses.",
