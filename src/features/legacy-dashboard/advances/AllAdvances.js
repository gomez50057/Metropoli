...
import allAdvancesStyles from './AllAdvances.module.css';
...
const AllAdvances = ({ projectId, onClose }) => {
  ...
  return (
    <div className={allAdvancesStyles["history-list"]}>
      ...
      <button onClick={onClose} className={allAdvancesStyles["close-button"]}>Cerrar</button>
    </div>
  );
};
