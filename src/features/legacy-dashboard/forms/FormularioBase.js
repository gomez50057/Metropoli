...
import { comisiones, subcomisiones } from '@/data/comisiones';
          ...
          <Form className={formularioStyles["formulario-container"]}>
            ...
            <div className={formularioStyles["form-row"]}>
              <div className={formularioStyles["form-group"]}>
                <label>Fecha:</label>
                <Field name="fecha" type="date" className={formularioStyles["input-field"]} disabled={disableFields.descripcionAcuerdo} />
                <ErrorMessage name="fecha" component="div" className={formularioStyles["error-message"]} />
              </div>
              ...
              <div className={formularioStyles["form-group"]}>
                ...
                <Field name="comision" as="select" className={formularioStyles["input-field"]} disabled={disableFields.descripcionAcuerdo}>
                ...
                <ErrorMessage name="comision" component="div" className={formularioStyles["error-message"]} />
              </div>

              {showFields && (
                <div className={formularioStyles["form-group"]}>
                  <label>Estado:</label>
                  <Field name="estado" as="select" className={formularioStyles["input-field"]} disabled={isEstadoDisabled}>
                    <option value="">Selecciona un estado</option>
                    <option value="EdoMex">Estado de México</option>
                    <option value="CDMX">Ciudad de México</option>
                    <option value="Hidalgo">Hidalgo</option>
                  </Field>
                  <ErrorMessage name="estado" component="div" className={formularioStyles["error-message"]} />
                </div>
              )}
            </div>
            ...
            <div className={formularioStyles["form-row"]}>
              {showFields && (
                <div className={formularioStyles["form-group"]}>
                  <label>Nombre:</label>
                  <Field name="nombre" type="text" className={formularioStyles["input-field"]} placeholder="Julio" />
                  <ErrorMessage name="nombre" component="div" className={formularioStyles["error-message"]} />
                </div>
              )}
              {showFields && (
                <div className={formularioStyles["form-group"]}>
            ...
            {showFields && (
              <div className={formularioStyles["form-group"]}>
                <label>Cargo:</label>
                <Field name="cargo" type="text" className={formularioStyles["input-field"]} placeholder="Agrega el cargo que tienes" />
                <ErrorMessage name="cargo" component="div" className={formularioStyles["error-message"]} />
              </div>
            )}
            ...
            <div className={formularioStyles["form-row"]}>
              {showFields && (
                <div className={formularioStyles["form-group"]}>
                  ...
                  />
                  <ErrorMessage name="telefono" component="div" className={formularioStyles["error-message"]} />
                </div>
              )}
              {showFields && (
                <div className={formularioStyles["form-group"]}>
                  ...
                  />
                  <ErrorMessage name="extension" component="div" className={formularioStyles["error-message"]} />
                </div>
              )}
              {showFields && (
                <div className={formularioStyles["form-group"]}>
            ...
            <button type="submit" className={formularioStyles["submit-button"]}>Enviar</button>
          </Form>
        </>
      )}
    </Formik>
